 ...
 * Description   : 本代码和yolo_infer_solo.py的区别
    本代码兼容vis（可以单独执行本代码在单张图片上测试） ，yolo_infer.py是在本代码基础上修改后（主要是输出格式），以适应FMS项目的接口
"""
import os
import time
...
class YoloDet():
    def __init__(self, trt_path, imgsz, device, data_type="coco"):
        """
        Args:
