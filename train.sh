...
# review测试
python -m torch.distributed.launch --nproc_per_node 1 --master_port 9588 train.py --workers 1 --device 1 --sync-bn --batch_size 128 --data data/fms.yaml --img 320 320 --cfg cfg/training/yolov7-tiny.yaml --weights '' --name yolov7-fms-test-review --hyp data/hyp.scratch.tiny.yaml # --resume 
# 单GPU训练
